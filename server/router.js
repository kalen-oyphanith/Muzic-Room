...
const router = (app) => {
  ...
  app.get('/getAccount', mid.requiresLogin, controllers.Post.getAccount);
  app.get('/getAllPosts', controllers.Post.getAllPosts);
  app.get('/login', mid.requiresSecure, mid.requiresLogout, controllers.Account.loginPage);
  app.post('/login', mid.requiresSecure, mid.requiresLogout, controllers.Account.login);
  app.post('/signup', mid.requiresSecure, mid.requiresLogout, controllers.Account.signup);
  app.post('/signupUpdate', mid.requiresSecure, mid.requiresLogin, controllers.Account.signupUpdate);
